...
def main():
    ...
    result = semiInformed.procura_informada(g,startPos, startTime, package_locations,node_positions, stats, semiInformed.procura_BFS)
    ...
    # result = informed.procura_informada(g,startPos,package_locations,node_positions, semiInformed.procura_DFS)
    # if result is not None:
    #     (path,custo) = result
    ...
    # result = informed.procura_informada(g,startPos,package_locations,node_positions, informed.procura_greedy)
    # if result is not None:
    #     (path,custo) = result
    #     print (path)
    #     print (custo)
    ...
    # result = informed.procura_informada(g,startPos,package_locations,node_positions, informed.procura_aStar)
    # if result is not None:
    #     (path,custo) = result
    #     print (path)
    #     print (custo)
